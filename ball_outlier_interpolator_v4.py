...
OUTPUT_PATH = "/home/lakshay/lx/ball_detection_tracking/clip2_output_v4.mp4"
DETECTION_JSON_PATH = "/home/lakshay/lx/ball_detection_tracking/clip2.json"
...
# Tuned conservatively from the existing best baseline
# (R=1339, Q velocity=1214, Q acceleration=5).
REGIME_DYNAMICS = {
    ...
    "Player Successful Tackle": RegimeDynamics(
        max_gap=15, q_velocity=2000.0, q_acceleration=600.0
    ),
...
class BallKalmanFilter:
    ...
    Process noise (Q) is mutated per frame based on the active action regime.
    """
    ...
    def __init__(self, dt, gravity_px_s2=GRAVITY_PX_PER_S2):
        ...
        # Q is set per-frame via apply_regime_dynamics.
    ...
    def apply_regime_dynamics(self, dynamics: RegimeDynamics):
        """Swap process noise based on the active action regime."""
        self.Q = np.diag(
            [
                1.0,
                1.0,
...
class VideoProcessor:
    ...
    def _apply_regime(self, frame_count):
        ...
        if ENABLE_PHASE_2:
            ...
            # Use baseline values, ignore regime
    ...
    def _select_best_detection(self, ball_detections, player_bboxes, regime, frame_count):
        ...
        # Existing logic: track-init or Mahalanobis selection.
