#!/usr/bin/env python3
"""Run ball_and_ball_out_1120 on clip1, keeping only ball_out (class 1) detections."""
...
if __name__ == "__main__":
    base.main(
        default_run_name="rfdetr_ball_out_only__clip1",
        default_output_root=CLIP1_FRESH_OUTPUT_ROOT,
        default_model_path=base.REPO_ROOT / "checkpoints" / "ball_and_ball_out_1120.pth",
