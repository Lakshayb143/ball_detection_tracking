...
OUTPUT_PATH = "/home/lakshay/lx/ball_detection_tracking/clip1_output_v6.mp4"
DETECTION_JSON_PATH = "/home/lakshay/lx/ball_detection_tracking/clip1_v6.json"
...
# ============================================================
def is_green_ground(frame: np.ndarray, position, box_size: float = 20.0) -> bool:
    """Return True if ≥ GREEN_FILTER_THRESHOLD fraction of the bbox pixels are grass-green."""
...
class VideoProcessor:
    ...
    def run(self):
        ...
        print(
            f"V6 green filter: rejected {self.green_rejections} interpolated position(s) "
